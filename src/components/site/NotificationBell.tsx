...
export function NotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute mt-2 right-0 md:right-0 left-1/2 md:left-auto -translate-x-1/2 md:translate-x-0 w-[calc(100vw-1rem)] md:w-auto min-w-0 md:min-w-[18rem] max-w-[calc(100vw-1rem)] overflow-hidden rounded-md border border-border bg-surface-1 shadow-xl">
